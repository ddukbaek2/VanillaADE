...
const MESSAGES =
{
    en:
    {
        ...
        "agent.tabGame": "New Game",
        "agent.gameProjectName": "Game Project Name",
        "agent.gameProjectNamePlaceholder": "Used as the folder name",
        "agent.gameProjectHint": "Creates a vanilla.js game project from the template, including the engine and dependencies.",
        "agent.gameProjectNameRequired": "Enter the game project name.",
        "agent.settingUp": "Preparing the project...",
        "agent.setupStep.clone": "Fetching the template and engine...",
        "agent.setupStep.install": "Installing dependencies...",
        "agent.setupStep.done": "Almost done...",
        "agent.npmMissing": "The npm command was not found. Install Node.js first.",
        "agent.installFailed": "Dependency installation failed. ({0})",

        "game.title": "Game Settings",
        "game.name": "Game Name",
        "game.engineVersion": "Engine Version",
        "game.engineVersionHint": "Checks out the libs/vanilla.js submodule at the selected tag or branch.",
        "game.engineApplyFailed": "Could not switch the engine version. ({0})",
        "game.resolution": "Reference Resolution",
        "game.resolutionHint": "Design resolution. Portrait uses a taller value, landscape a wider one.",
        "game.resolutionRequired": "Enter a valid resolution.",
        "game.orientation": "Orientation",
        "game.orientationPortrait": "Portrait",
        "game.orientationLandscape": "Landscape",
        "game.orientationAny": "Both",
        "game.markets": "Distribution Targets",
        "game.marketHint": "Only web deploy is wired to a build for now.",
        "game.marketPreparing": "(coming soon)",
        "game.marketRequired": "Select at least one target.",
        "game.saving": "Saving...",
        "game.saved": "Game settings saved.",

        "market.web-deploy": "Web / Deploy",
        "market.playstore": "Play Store",
        "market.onestore": "ONE store",
        "market.appstore": "App Store",
        "market.appintoss": "Apps in Toss",
        "market.steam": "Steam",

        "action.web-build": "Build",
        "action.asset-check": "Check Assets",
        "action.install": "Install Dependencies",
        "action.running": "Running...",
        "action.succeeded": "Finished successfully.",
        "action.failed": "Failed. ({0})",
        "action.startFailed": "Could not start. Another action may still be running.",
        "action.cancel": "Stop",
    ...
    ko:
    {
        ...
        "agent.tabClone": "클론",
        "agent.tabGame": "새 게임",
        "agent.gameProjectName": "게임 프로젝트 이름",
        "agent.gameProjectNamePlaceholder": "폴더 이름으로 사용됩니다",
        "agent.gameProjectHint": "템플릿에서 vanilla.js 게임 프로젝트를 만들고 엔진과 의존성까지 받아옵니다.",
        "agent.gameProjectNameRequired": "게임 프로젝트 이름을 입력하세요.",
        "agent.settingUp": "프로젝트를 준비하는 중입니다...",
        "agent.setupStep.clone": "템플릿과 엔진을 받아오는 중입니다...",
        "agent.setupStep.install": "의존성을 설치하는 중입니다...",
        "agent.setupStep.done": "마무리하는 중입니다...",
        "agent.npmMissing": "npm 명령을 찾을 수 없습니다. Node.js 를 먼저 설치하세요.",
        "agent.installFailed": "의존성 설치에 실패했습니다. ({0})",

        "game.title": "게임 설정",
        "game.name": "게임 이름",
        "game.engineVersion": "엔진 버전",
        "game.engineVersionHint": "선택한 태그 또는 브랜치로 libs/vanilla.js 서브모듈을 맞춥니다.",
        "game.engineApplyFailed": "엔진 버전을 바꾸지 못했습니다. ({0})",
        "game.resolution": "기준 해상도",
        "game.resolutionHint": "디자인 기준 해상도입니다. 세로 게임은 세로가 큰 값, 가로 게임은 가로가 큰 값을 넣습니다.",
        "game.resolutionRequired": "올바른 해상도를 입력하세요.",
        "game.orientation": "화면 방향",
        "game.orientationPortrait": "세로 모드",
        "game.orientationLandscape": "가로 모드",
        "game.orientationAny": "가로세로 모드",
        "game.markets": "배포 대상",
        "game.marketHint": "현재 빌드가 연결된 대상은 웹 배포뿐입니다.",
        "game.marketPreparing": "(준비 중)",
        "game.marketRequired": "배포 대상을 하나 이상 선택하세요.",
        "game.saving": "저장하는 중입니다...",
        "game.saved": "게임 설정을 저장했습니다.",

        "market.web-deploy": "웹 · 배포",
        "market.playstore": "플레이스토어",
        "market.onestore": "원스토어",
        "market.appstore": "앱스토어",
        "market.appintoss": "앱인토스",
        "market.steam": "스팀",

        "action.web-build": "빌드",
        "action.asset-check": "자산 점검",
        "action.install": "의존성 설치",
        "action.running": "실행 중입니다...",
        "action.succeeded": "정상적으로 끝났습니다.",
        "action.failed": "실패했습니다. ({0})",
        "action.startFailed": "실행하지 못했습니다. 다른 작업이 아직 진행 중일 수 있습니다.",
        "action.cancel": "중단",
