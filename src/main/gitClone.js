...
//=================================================================================================
function runGitClone(repositoryUrl, targetDirectoryPath)
{
    const clonePromise = new System.Promise(function (resolve)
    {
        const commandArguments = ["clone", repositoryUrl, targetDirectoryPath];
...
//=================================================================================================
async function cloneRepository(repositoryUrl, parentDirectoryPath)
{
    ...
    const cloneResult = await runGitClone(repositoryUrl, targetDirectoryPath);
    return cloneResult;
}
